...
const Signup = () => {
  ...
  return (
   <>
   <Grid container style={{ display:'flex',justifyContent:'center' , alignItems:'center', height:'100vh',background: 'linear-gradient(90deg, #812868 0%, #f954a4 100%)'}}>
    <Grid item lg={3} >
     <Card>
        <CardContent>
            <Typography>Please Do Register Yourself Here!</Typography>
            <Box mt={2}>
            ...
            <Typography>Already Signup <Link to='/login'>Login</Link></Typography>
        </CardContent>
     </Card>
    </Grid>
   </Grid>
